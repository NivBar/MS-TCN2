...
if args.action == "train":
    ...
    for i in range(utils.start_idx, utils.available_folds):
        ...
        # kin_batch_gen_train = BatchGenerator(num_classes, actions_dict, gt_path, [kinematics_path], sample_rate,
        #                                      kinematics=True)
        # kin_batch_gen_train.read_data(train_files)
        ...
        # kin_batch_gen_val = BatchGenerator(num_classes, actions_dict, gt_path, [kinematics_path], sample_rate,
        #                                    kinematics=True)
